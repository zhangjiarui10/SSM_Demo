...
<body>
    <form action="${pageContext.request.contextPath}/book/update.do" method="post" accept-charset="UTF-8">
        <div class="form-group">
            <label for="bookId">编号</label>
            <input type="text" class="form-control" id="bookId" placeholder="Id" name="bookId" value="<%=request.getParameter("bookId")%>" readonly>
        </div>
        <div class="form-group">
